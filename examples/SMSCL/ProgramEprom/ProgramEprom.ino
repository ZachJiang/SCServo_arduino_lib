...
void setup()
{
  ...
  sm.writeByte(0xfe, SMSCL_ID, 0);//ID
  delay(50);
  sm.writeWord(0xfe, SMSCL_MIN_ANGLE_LIMIT_L, 1000);
  delay(50);
  sm.writeWord(0xfe, SMSCL_MAX_ANGLE_LIMIT_L, 3000);
  delay(50);
  sm.writeWord(0xfe, SMSCL_MAX_TORQUE_L, 1000);
  delay(50);
  sm.writeWord(0xfe, SMSCL_PUNCH_L, 16);
  delay(50);
